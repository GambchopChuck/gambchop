...
export default function PersistentVideo() {
  ...
  return (
    <div style={{
      ...
      background: '#07070c',
      padding: collapsed ? '7px 24px 7px' : '14px 24px 18px',
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              padding: '3px 9px', transition: 'color 0.15s, border-color 0.15s',
              flexShrink: 0,
            }}
          >
        ...
        {/* Video wrapper — only unmounts visually, not in DOM, keeping iframe alive */}
        <div style={{
