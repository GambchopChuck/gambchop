...
const GOLD_CFG: MedalConfig = {
  rank: '01', label: 'GOLD',
  borderColor: T.gold,
  glow: `0 0 56px rgba(250,204,21,0.4), inset 0 0 40px rgba(250,204,21,0.06)`,
  hoverGlow: `0 0 72px rgba(250,204,21,0.55), inset 0 0 50px rgba(250,204,21,0.10)`,
...
const SILVER_CFG: MedalConfig = {
  ...
  glow: `0 0 36px rgba(148,163,184,0.25), inset 0 0 18px rgba(148,163,184,0.04)`,
  hoverGlow: `0 0 48px rgba(148,163,184,0.38), inset 0 0 24px rgba(148,163,184,0.08)`,
...
const BRONZE_CFG: MedalConfig = {
  ...
  hoverGlow: `0 0 48px rgba(234,88,12,0.34)`,
  squareSize: 44, nameFontSize: 24, countFontSize: 44,
