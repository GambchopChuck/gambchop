            ...
            <div style={{ maxWidth: 1400, margin: '0 auto', padding: '40px 24px 24px' }}>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 40, justifyContent: 'space-between' }}>
                <div style={{ minWidth: 200 }}>
                  ...
                  <p style={{ fontSize: 10, color: '#ffffff', lineHeight: 1.7, marginTop: 10, maxWidth: 240 }}>Sports betting data visualization. Historical outcomes only — not betting advice.</p>
                </div>
                <div style={{ minWidth: 140 }}>
                  <div style={{ fontSize: 9, color: '#ffffff', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 8, fontWeight: 700 }}>Product</div>
                ...
                <div style={{ minWidth: 140 }}>
                  <div style={{ fontSize: 9, color: '#ffffff', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 8, fontWeight: 700 }}>Company</div>
                ...
                <div style={{ minWidth: 140 }}>
                  <div style={{ fontSize: 9, color: '#ffffff', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 8, fontWeight: 700 }}>Legal</div>
              ...
              <div style={{ display: 'flex', gap: 16, marginTop: 28 }}>
                <a href="https://x.com/" target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: '#ffffff', textDecoration: 'none' }}>X</a>
                <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: '#ffffff', textDecoration: 'none' }}>Instagram</a>
                <a href="https://tiktok.com/" target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: '#ffffff', textDecoration: 'none' }}>TikTok</a>
                <a href="https://youtube.com/" target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: '#ffffff', textDecoration: 'none' }}>YouTube</a>
              </div>
              <div style={{ borderTop: '1px solid #14141c', marginTop: 24, paddingTop: 20 }}>
                <p style={{ fontSize: 10, color: '#ffffff', lineHeight: 1.8, margin: 0, maxWidth: 900 }}>
                ...
                <p style={{ fontSize: 10, color: '#ffffff', letterSpacing: '0.1em', marginTop: 14 }}>© {new Date().getFullYear()} STRHUCK Ventures. All rights reserved.</p>
              </div>
            </div>
          </footer>
          </ChopperTransitionProvider>
